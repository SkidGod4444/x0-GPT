...
export default function Home() {
  return (
    ...
    <div className="h-full w-full items-center justify-center flex flex-col overflow-hidden my-20">
        ...
        <AnncBtn/>
        {/* Title */}
      <h1 className="text-4xl font-bold md:text-6xl lg:text-7xl max-w-10xl mx-auto text-center relative z-20 py-6 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white">
        Talk to whatever you want <br /> using <Cover>x0-GPT</Cover> for free!
      </h1>
